...
const ImageGenerationForm = () => {
  ...
  return (<div className="imageGen">
    <div>
        <h1 className="font-extrabold text-[#222328] text-[32px]">AI Image Gen</h1>
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">Generated by DALL-E AI</p>
      </div>
    ...
    {!loading && output && (
      <div className="result-image">
        ...
        <div className="action">
            {user && <button onClick={uploadImage}>Upload To Showcase</button>}
        </div>
      </div>
    )}
